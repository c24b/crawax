...
Goose is a fork of python-goose https://github.com/grangier/python-goose.git
Thanks to Xavier Grangier. goose is now a simple module for article extraction.
